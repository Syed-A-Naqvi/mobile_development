...
class _NotificationPageState extends State<NotificationPage> {
  ...
  void _startCountdown() {
    setState(() {
      _countdown = 5;  // Reset countdown to 3 seconds
    });
  ...
  Future<void> scheduleDailyNotification() async {
    ...
    await flutterLocalNotificationsPlugin.zonedSchedule(
      ...
      _nextInstanceOfTime(13, 24),  // Function to get the next instance of 5:30 PM
      platformChannelSpecifics,  // Notification details
      matchDateTimeComponents: DateTimeComponents.time,  // Schedule the notification at the same time every day
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text('Show Notification After 5 Seconds'),  // Button label
            ),
